...
export interface ApiGiftGift extends Schema.CollectionType {
    ...
    attributes: {
        ...
        given: Attribute.Integer & Attribute.DefaultTo<0>;
        win_rate: Attribute.Float & Attribute.DefaultTo<0>;
...
export interface ApiLotteryLottery extends Schema.CollectionType {
    ...
    attributes: {
        gift_id: Attribute.Relation<
            'api::lottery.lottery',
            'manyToOne',
            'api::gift.gift'
        >;
        player_id: Attribute.Relation<
            'api::lottery.lottery',
            'manyToOne',
            'api::player.player'
        >;
        is_win: Attribute.Boolean & Attribute.DefaultTo<false>;
        createdAt: Attribute.DateTime;
        updatedAt: Attribute.DateTime;
        createdBy: Attribute.Relation<
            'api::lottery.lottery',
...
export interface ApiPlayerPlayer extends Schema.CollectionType {
    ...
    attributes: {
        ...
        spin: Attribute.Integer & Attribute.DefaultTo<0>;
        can_spin: Attribute.Integer & Attribute.DefaultTo<0>;
        lotteries: Attribute.Relation<
            'api::player.player',
            'oneToMany',
            'api::lottery.lottery'
